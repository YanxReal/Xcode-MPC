...
`index.js` (2250 líneas) es intencionalmente **monolítico** para facilitar distribución con OpenCode (copiar un archivo + `yarn install`).
...
├── TOOLS (52 definiciones JSON Schema)
├── Handlers (52 async functions handle_*)
