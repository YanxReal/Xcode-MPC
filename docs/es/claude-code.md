...
# Verificar
claude mcp list
# xcode: node /Users/YanxReal/Dev/Tools/Xcode-MPC/index.js (connected) — 52 tools
...
# Debe mostrar: 52 tools (xcode_build, simctl_list, etc.)
...
Todos usan el mismo `index.js` stdio — mismo `tools/list` (52 tools). Ver también: [`opencode.md`](opencode.md) · [`codex.md`](codex.md) · [`tools.md`](tools.md)