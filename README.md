...
| [`skills.md`](docs/skills.md) | Everyone | 5 skills (52 tools): `xcode-mpc`, `xcode-build`, `xcode-simulator-vision`, `xcode-assets`, `xcode-package` — `make install-skills` |

---

## 🧩 Skills (5 Skills, 52 Tools)
